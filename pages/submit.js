    ...
    return (
        <div className={styles.container}>
            <form action="/api/submit" method="post" encType="multipart/form-data">
                ...
                <div className={styles.section}>
                    <p>Please upload 2 photos (preferrably photos that you took) from locations that are relevant to you.</p>
                </div>
                <div className={styles.section}>
                    <label htmlFor="photo_1">Choose a photo: </label>
                    <input type="file" id="photo_1" name="photo_1" accept="image/png, image/jpeg" />
                    <p>Drag the marker to the precise location that the photo was taken from.</p>
                ...
                <div className={styles.section}>
                    ...
                    <input type="file" id="photo_2" name="photo_2" accept="image/png, image/jpeg" />
                    <p>Drag the marker to the precise location that the photo was taken from.</p>
